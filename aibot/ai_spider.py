...
# 正式: scrapy runspider ai_spider.py -o aibot.csv
# 测试: scrapy runspider ai_spider.py -o aibot_test.csv

class AISpider(scrapy.Spider):
    name = "ai_spider"
    allowed_domains = ["www.ai-bot.cn"]
    start_urls = []

    for i in range(6000, 0, -1):
        start_urls.append("https://www.ai-bot.cn/sites/%s.html" % i)
    ...
    # 测试使用
    # start_urls = ['https://www.ai-bot.cn/sites/49.html', 'https://www.ai-bot.cn/sites/5037.html']
